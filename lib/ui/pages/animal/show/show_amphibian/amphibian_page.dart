...
class ListAmphibian extends StatefulWidget {
  const ListAmphibian({Key? key}) : super(key: key);

  @override
  _ListAmphibianState createState() => _ListAmphibianState();
}

class _ListAmphibianState extends State<ListAmphibian> {
  final CollectionReference _amphibian =
      FirebaseFirestore.instance.collection("list_amphibian");
